...
call python -m data_integrity_tool.main create test_archive.zip
...
call python -m data_integrity_tool.main verify test_archive.zip --hash-file test_archive.zip.sha256
...
call python -m data_integrity_tool.main verify test_archive.zip --content-hash-file test_archive.zip.content.sha256
...
call python -m data_integrity_tool.main verify test_archive.zip
